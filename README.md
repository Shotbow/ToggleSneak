...
<kbd>G</kbd> to enable or disable toggle sneaking.
<br>
<kbd>H</kbd> to enable or disable toggle sprinting.

> [!IMPORTANT]  
> As of Minecraft 1.21.6, <kbd>G</kbd> is now bound to '<a href="https://www.minecraft.net/en-us/article/minecraft-1-21-6-pre-release-1">Quick Actions</a>' by default. 
> This will override the ToggleSneak bound action, so you will need to change either key bind (Options ➡️ Controls ➡️ Key Binds).
> <br><br>
...
A: You will need to turn Minecraft's sneak mode to 'Hold'. ToggleSneak does this for you when you enable it, you can use the keybinding (default: <kbd>G</kbd>) to quickly disable and then enable it. Or you can go into the client settings:
- Options
- Controls
- Key Binds...
